...
def sair():
    banner()
    print('\033[1;34m Obrigado por usar o painel NETWORKING HACKING')
    exit()
...
def banner():
    clear()
    banner = ["\n \033[1;33m" ".--------.____________", "|| ° ° ° °     .2021.|| \033[1;32m®\033[1;33m", "||                    | \033[1;32m©\033[1;33m", "||\     ______________________", "|| \   // ° ° ° ° ° ° ° ° ° °/", "||\ \ //                    /", "|| \ //                    /", "||\ //                    /", "|| //                    /", "||//                    /", "||/                    /", "|/____________________/", "\033[1;31mArquivo NETWORKING HACKING \033[m\n", "\033[1;35m<<<   PAINEL NETWORKING HACKING " + str(datetime.date.today()) + "   >>>", "\033[1;32m=======================================\n"]
    for i in banner:
        print('', i)
        time.sleep(0.01)
